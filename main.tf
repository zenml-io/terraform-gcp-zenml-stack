...
locals {
  ...
  # that version.
  use_workload_identity = (local.is_zenml_cloud || local.is_zenml_cloud_staging) && var.orchestrator != "skypilot" && (local.zenml_version != null && split(".", local.zenml_version)[1] > 63)
}
